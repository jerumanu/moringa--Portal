...
schema_view = get_schema_view(
    openapi.Info(
        title="Moringa Portal API",
        default_version='v1',
        description="Welcome to Moringa Portal API",
        terms_of_service="https://mejerumanu.com",
        contact=openapi.Contact(email="moringa@moringa.org"),
